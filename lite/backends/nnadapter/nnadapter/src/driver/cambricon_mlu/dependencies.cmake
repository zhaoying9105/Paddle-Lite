...
# yolobox mlu plugin library
# find_library(CAMBRICON_MLU_SDK_MAGICMIND_YOLOBOX_PLUGIN_FILE NAMES yolo_box_plugin
#   PATHS ${NNADAPTER_CAMBRICON_MLU_SDK_ROOT}/${CAMBRICON_MLU_SDK_SUB_LIB_PATH}
#   CMAKE_FIND_ROOT_PATH_BOTH)
# if(NOT CAMBRICON_MLU_SDK_MAGICMIND_YOLOBOX_PLUGIN_FILE)
#     message(FATAL_ERROR "Missing libyolo_box_plugin.so in ${NNADAPTER_CAMBRICON_MLU_SDK_ROOT}/${CAMBRICON_MLU_SDK_SUB_LIB_PATH}")
# endif()
# add_library(yolo_box_plugin SHARED IMPORTED GLOBAL)
# set_property(TARGET yolo_box_plugin PROPERTY IMPORTED_LOCATION ${CAMBRICON_MLU_SDK_MAGICMIND_YOLOBOX_PLUGIN_FILE})

# # multiclass nms3 mlu plugin library
# find_library(CAMBRICON_MLU_SDK_MAGICMIND_MULTICLASS_NMS3_PLUGIN_FILE NAMES multiclass_nms3_plugin
#   PATHS ${NNADAPTER_CAMBRICON_MLU_SDK_ROOT}/${CAMBRICON_MLU_SDK_SUB_LIB_PATH}
#   CMAKE_FIND_ROOT_PATH_BOTH)
# if(NOT CAMBRICON_MLU_SDK_MAGICMIND_MULTICLASS_NMS3_PLUGIN_FILE)
#     message(FATAL_ERROR "Missing libmulticlass_nms3_plugin.so in ${NNADAPTER_CAMBRICON_MLU_SDK_ROOT}/${CAMBRICON_MLU_SDK_SUB_LIB_PATH}")
# endif()
# add_library(multiclass_nms3_plugin SHARED IMPORTED GLOBAL)
# set_property(TARGET multiclass_nms3_plugin PROPERTY IMPORTED_LOCATION ${CAMBRICON_MLU_SDK_MAGICMIND_MULTICLASS_NMS3_PLUGIN_FILE})

# set(DEPS ${DEPS} magicmind magicmind_runtime magicmind_plugin yolo_box_plugin multiclass_nms3_plugin)