...
#include "driver/cambricon_mlu/operation/non_max_suppression_with_score.h"
#include "utility/debug.h"
#include "utility/logging.h"
namespace nnadapter {
namespace cambricon_mlu {

int ConvertNonMaxSuppressionWithScore(Converter* converter, core::Operation* operation) {
  NON_MAX_SUPPRESSION_WITH_SCORE_OPERATION_EXTRACT_INPUTS_OUTPUTS
  ...
  multiclass_nms_node->SetOutputAllScoresVal(true);
  ...
  std::vector<int> split_v_size = {1, 21};
  auto split_v_tensor =
